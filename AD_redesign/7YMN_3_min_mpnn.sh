...
tied_positions="10 15 24 10,10 15 24 10,10 15 24 10"

python /work/CAND/shared/Chens/AD_fibrils/ProteinMPNN/helper_scripts/parse_multiple_chains.py --input_path=$folder_with_pdbs --output_path=$path_for_parsed_chains
